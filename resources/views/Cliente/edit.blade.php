    ...
    <div class="panel-body">     
     <div class="table-container">
      <form method="POST" action="{{ route('cliente.update',$cliente->id) }}"  role="form">
       ...
       <div class="form-group">
        <textarea name="direccion" class="form-control input-sm"  placeholder="Direccion" value="{{$cliente->direccion}}"></textarea>
       </div>
       <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="fechanac" id="fechanac" class="form-control input-sm" value="{{$cliente->fechanac}}">
         </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="fechains" id="fechains" class="form-control input-sm" value="{{$cliente->fechains}}">
         </div>
        </div>
       </div>
